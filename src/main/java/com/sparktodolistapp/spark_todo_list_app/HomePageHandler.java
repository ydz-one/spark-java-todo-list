...
public class HomePageHandler implements Route{
	private final String htmlHead = "<html><head><title>Todo List App</title>" +
	...
	public Object handle(Request request, Response response) throws Exception {
		return htmlHead + "<body><div class=\"jumbotron\"><h3>Welcome to our TodoList!<h3>" + 
				"<button type=\"button\" class=\"btn btn-primary\" onclick=\"location.href='/todo'\">Start App</button></div>" + bootstrapJS + "</body></html>";
	}
